...
export default async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    let payload: ShowTodoPayload = new ShowTodoPayload(Object.assign({}, req.body, req.query, req.params));
    const validationErr: string | void = await Validate(ShowTodoPayload, payload);
    if (validationErr) {
