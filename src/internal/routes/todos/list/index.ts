...
export default async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    let payload: ListTodosPayload = new ListTodosPayload(Object.assign({}, req.body, req.query, req.params));
    const validationErr: string | void = await Validate(ListTodosPayload, payload);
    if (validationErr) {
